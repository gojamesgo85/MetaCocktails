...
let ramosGinFizz = Cocktail(name: "Ramos Gin Fizz",
                            image: CocktailImage(imageName: "RamosNoBackground"),
                            backgroundColor: .brandPrimaryOrange,
...
let ramosGinFizzBuild: Build = Build(instructions: [Instruction(step: 1, method: "Chill your 14oz. collins glass ahead of time"),
